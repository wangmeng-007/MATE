...
def get_argument_parser():
    ...
    parser.add_argument('--data_path', default='/home/s1/ESA-main6/data/f30k/',
                        help='path to datasets')
    parser.add_argument('--data_name', default='f30k_precomp',
                        help='{coco,f30k}_precomp')
    parser.add_argument('--vocab_path', default='/home/s1/ESA-main6/data/vocab/',
    ...
    parser.add_argument('--transformer_lr', type=float, default=0.0005,
                        help='Learning rate for transformer encoder.')  # 添加 transformer_lr 参数

    parser.add_argument('--momentum', type=float, default=0.995,
                        help='Momentum for moving average in momentum distillation')
